...
public class DateChooserPanel extends JPanel {
	...
	public static DateChooserPanel getInstance() {
		return new DateChooserPanel();
	}
 
	public static DateChooserPanel getInstance(Date date) {
		return new DateChooserPanel(date);
	}
 
	public static DateChooserPanel getInstance(String format) {
		return new DateChooserPanel(format);
	}
 
	public static DateChooserPanel getInstance(Date date, String format) {
		return new DateChooserPanel(date, format);
	}
 
	/** 
	 * Creates a new instance of DateChooser 
	 */
	private DateChooserPanel() {
		this(new Date());
	}
 
	private DateChooserPanel(Date date) {
		this(date, "yyyy年MM月dd日");
	}
 
	private DateChooserPanel(String format) {
		this(new Date(), format);
	}
 
	private DateChooserPanel(Date date, String format) {
		initDate = date;
	...
	public static void main(String[] args) {
		DateChooserPanel dateChooser1 = DateChooserPanel.getInstance("yyyy-MM-dd");
		DateChooserPanel dateChooser2 = DateChooserPanel.getInstance("yyyy-MM-dd");
